...
public final class ScreenPosition {
     ...
     *
     * @param x
     *         Relative screen x value (horizontal) of the position.
     * @param y
     *         Relative screen y value (vertical) of the position.
     ...
     *
     * @param x
     *         Absolute screen x value (horizontal) of the position.
     * @param y
     *         Absolute screen y value (vertical) of the position.
     * @return The created ScreenPosition object.
     */
    ...
    /**
     * @param x
     *         The relative x coordinate to be set. Ranging from 0 to 1.
     * @param y
     *         The relative y coordinate to be set. Ranging from 0 to 1.
     */
    ...
    /**
     * @param x
     *         The absolute x coordinate to be set.
     * @param y
     *         The absolute y coordinate to be set.
     */
    ...
    public String toString() {
        return String.format(getClass().getSimpleName() + "[absoluteX=%d,absoluteY=%d,relativeX=%.1f,relativeY=%.1f]",
                             this.getAbsoluteX(),
                             this.getAbsoluteY(),
                             this.getRelativeX(),
                             this.getRelativeY());
